...
public OnPluginStart()
{
	...
	hCvarMedBonusFactor = CreateConVar("am_items_med_bonus_factor", "0.2", "Unused Medkits can gain this * Map Distance", FCVAR_NONE, true, 0.0, true, 1000.0);
	...
	hCvarDeathPenaltyFactor = CreateConVar("am_death_penalty_factor", "0.25", "Reduce the Bonus when someone died", FCVAR_NONE, true, 0.0, true, 1.0);
...
public Action:CmdBonus(client, args)
{
	...
	new Float:fItemsMaxBonus = float(iPillWorth * iTeamSize + iMedWorth * iTeamSize + iThrowWorth * iTeamSize);
